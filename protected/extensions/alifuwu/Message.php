<?php
include_once (dirname(__FILE__) . '/PushMsg.php');
class Message {
	...
	public function mkAckMsg($toUserId) {
		...
		$response_xml = "<XML><ToUserId><![CDATA[" . $toUserId . "]]></ToUserId><AppId><![CDATA[" . $AopConfig ['app_id'] . "]]></AppId><CreateTime>" . time () . "</CreateTime><MsgType><![CDATA[ack]]></MsgType></XML>";
