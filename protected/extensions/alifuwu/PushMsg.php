<?php
include_once(dirname(__FILE__) . '/HttpRequst.php');
include_once(dirname(__FILE__) . '/function.inc.php');
include_once(dirname(__FILE__) . '/aop/request/AlipayMobilePublicMessageCustomSendRequest.php');
include_once(dirname(__FILE__) . '/aop/request/AlipayMobilePublicMenuAddRequest.php');
include_once(dirname(__FILE__) . '/aop/request/AlipayMobilePublicMenuGetRequest.php');
include_once(dirname(__FILE__) . '/aop/request/AlipayMobilePublicMenuUpdateRequest.php');
// $pushmsg = new PushMsg ();
// $pushmsg->test ();
class PushMsg
{
     ...
     */
    public function sendRequest($biz_content, $appid)
    {
        $custom_send = new AlipayMobilePublicMessageCustomSendRequest ();
        $custom_send->setBizContent($biz_content);
        
        return aopclient_request_execute($custom_send, $appid);
    }
    ...
    public function getMenu(){
        ...
        return without_request_execute($custom_send, NULL);
    }
    ...
    public function pushMsgRequest($biz_content)
    {
        ...
        return aopclient_request_execute($request, NULL);
    }
    ...
    public function downMediaRequest($biz_content, $fileName)
    {
        ...
        $paramsArray = array(
            ...
            'charset' => $AopConfig ['charset'],
            'sign_type' => 'RSA',
            'app_id' => $AopConfig ['app_id'],
        ...
        // print_r($paramsArray);
        include_once(dirname(__FILE__) . '/AlipaySign.php');
        $as = new AlipaySign ();
        $sign = $as->sign_request($paramsArray, $AopConfig ['merchant_private_key_file']);
    ...
    public function sendMsgRequest($biz_content, $isMultiSend = FALSE)
    {
        ...
        return HttpRequest::sendPostRequst($AopConfig ['gatewayUrl'], $paramsArray);
    }
