...
*
* 增加属性设置 WxPayApi()  设置wxpay_config
* 
* 增加属性设置 WxPayOrderQuery()  设置wxpay_config
*/
...
class MicroPay
{
	...
	public function pay($microPayInput)
	{
		...
		$api = new WxPayApi();
		//设置商户信息配置信息
		$api->wxpay_config = $this->wxpay_config;
	...
	public function query($out_trade_no, &$succCode)
	{
		...
		//设置商户信息配置信息
		$queryOrderInput->wxpay_config = $this->wxpay_config;
	...
	public function cancel($out_trade_no, $depth = 0)
	{
		...
		//设置商户信息配置信息
		$clostOrder->wxpay_config = $this->wxpay_config;
