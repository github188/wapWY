...
class ActivationCode extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('merchant_id, num, used_num, status, flag', 'numerical', 'integerOnly'=>true),
			array('code', 'length', 'max'=>32),
			array('start_time, end_time, create_time, last_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, merchant_id, code, num, used_num, status, start_time, end_time, flag, create_time, last_time', 'safe', 'on'=>'search'),
		);
	}
