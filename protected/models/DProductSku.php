...
/**
 * This is the model class for table "{{d_product_sku}}".
 *
 * The followings are the available columns in table '{{d_product_sku}}':
 * @property integer $id
 ...
 */
class DProductSku extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
                    'product' => array(self::BELONGS_TO,'DProduct','product_id'),
		);
	}
	 ...
	 * @return DProductSku the static model class
	 */
