 ...
 *
 * The followings are the available columns in table '{{m_statistics}}':
 * @property integer $id
 ...
 */
class MStatistics extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('agent_id, merchant_id, total_trade_num, new_trade_num, new_trade_refund_num, total_trade_alipay_num, new_trade_alipay_num, new_trade_alipay_refund_num, total_trade_wechat_num, new_trade_wechat_num, new_trade_wechat_refund_num, total_trade_unionpay_num, new_trade_unionpay_num, new_trade_unionpay_refund_num, total_trade_stored_num, new_trade_stored_num, new_trade_stored_refund_num, total_trade_cash_num, new_trade_cash_num, new_trade_cash_refund_num, total_trade_coupon_num, total_alipay_commision_num, total_wechat_commision_num, new_trade_coupon_num, new_alipay_commision_num, new_wechat_commision_num, total_user_num, total_alipayfans_num, total_wechatfans_num, total_member_num, new_user_num, new_alipayfans_num, new_wechatfans_num, new_member_num, total_store_num, new_store_num, active_store_num, flag', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return MStatistics the static model class
	 */
