...
class Notice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('admin_id, release_status, flag', 'numerical', 'integerOnly'=>true),
			array('title', 'length', 'max'=>50),
			array('content, release_time, create_time, last_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, admin_id, title, content, release_status, release_time, create_time, last_time, flag', 'safe', 'on'=>'search'),
		);
	}
