...
/**
 * This is the model class for table "{{report_form_month}}".
 *
 * The followings are the available columns in table '{{report_form_month}}':
 * @property integer $id
 ...
 */
class ReportFormMonth extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('store_id, total_num, wechat_num, alipay_num, cash_num, stored_num, unionpay_num', 'numerical', 'integerOnly'=>true),
			...
			array('id, store_id, total_money, total_num, wechat_money, wechat_num, alipay_money, alipay_num, cash_money, cash_num, stored_money, stored_num, unionpay_money, unionpay_num, month, create_time, last_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ReportFormMonth the static model class
	 */
