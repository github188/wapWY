 ...
 *
 * The followings are the available columns in table '{{total_statistics}}':
 * @property integer $id
 ...
 * @property integer $total_agent_num
 * @property integer $new_agent_num
 * @property string $create_time
 * @property string $last_time
 * @property integer $flag
 */
class TotalStatistics extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'total_agent_num' => 'Total Agent Num',
			'new_agent_num' => 'New Agent Num',
	...
	public function search()
	{
		...
		$criteria->compare('total_agent_num',$this->total_agent_num);
		$criteria->compare('new_agent_num',$this->new_agent_num);
	 ...
	 * @return TotalStatistics the static model class
	 */
