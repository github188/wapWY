...
class UserTag extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, tag_id, flag', 'numerical', 'integerOnly'=>true),
			array('tag_name', 'length', 'max'=>32),
			array('tag_value', 'length', 'max'=>255),
			array('last_time, create_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, tag_id, tag_name, tag_value, last_time, create_time, flag', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tag_value',$this->tag_value,true);
