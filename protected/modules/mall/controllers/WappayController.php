 ...
 * Time: 12:52
 */
class WappayController extends MallController
{
    ...
    public function actionScWappay()
    {
        ...
        $synNotifyUrl = Yii::app()->createUrl('uCenter/Notify/SynNotify', array('encrypt_id' => $encrypt_id));
        $asyNotifyUrl = Yii::app()->createUrl('uCenter/Notify/AsyNotify', array('encrypt_id' => $encrypt_id));
