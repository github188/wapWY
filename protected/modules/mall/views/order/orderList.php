...
<header>
    <nav class="topnav clearfix">
        <ul>
            <li>
                <a href="<?php echo Yii::app()->createUrl('mall/order/orderList', array('pay_status' => ORDER_STATUS_UNPAID, 'encrypt_id' => $encrypt_id)); ?>"
            ...
            <li>
                <a href="<?php echo Yii::app()->createUrl('mall/order/orderList', array('order_status' => ORDER_STATUS_WAITFORDELIVER, 'pay_status' => ORDER_STATUS_PAID, 'encrypt_id' => $encrypt_id)); ?>"
            ...
            <li>
                <a href="<?php echo Yii::app()->createUrl('mall/order/orderList', array('order_status' => ORDER_STATUS_DELIVER, 'pay_status' => ORDER_STATUS_PAID, 'encrypt_id' => $encrypt_id)); ?>"
                   class="<?php if (isset($_GET['order_status'])) {
            ...
            <li class="lastLi">
                <a href="<?php echo Yii::app()->createUrl('mall/order/orderList', array('order_status' => ORDER_STATUS_PART_COMPLETE, 'pay_status' => ORDER_STATUS_PAID, 'encrypt_id' => $encrypt_id)); ?>"
                   class="<?php if (isset($_GET['order_status'])) {
            ...
            <article class="item clearfix">
                <div class="itemTop clearfix">
                    ...
                    <?php if ($v['pay_status'] == ORDER_STATUS_UNPAID) { ?>
                        <div class="itemR">
                            <a href="<?php echo Yii::app()->createUrl('mall/order/cancleOrder', array('order_id' => $v['id'], 'encrypt_id' => $encrypt_id)); ?>"
				...
				<span class="btn"> 
				 <?php if ($v['pay_status'] == ORDER_STATUS_UNPAID) { ?>
                     <input type="button" class="btn_com" value="付款"
                            onclick="window.location.href = '<?php echo Yii::app()->createUrl('mall/order/OrderPay', array('order_id' => $v['id'], 'encrypt_id' => $encrypt_id)) ?>';">
                 <?php } ?>
                    <?php if ($v['pay_status'] == ORDER_STATUS_PAID && $v['order_status'] == ORDER_STATUS_DELIVER) { ?>
                        <a href="<?php echo Yii::app()->createUrl('mall/order/confirmReceipt', array('order_id' => $v['id'], 'encrypt_id' => $encrypt_id)); ?>"
                           onclick="return confirm('确认收货吗');" class="btn_com_gray" style="width:90px">确认收货</a>
                        <!-- <a href="" class="btn_com_gray">物流</a> -->
                    <?php } ?>


                    <a href="<?php echo Yii::app()->createUrl('mall/order/orderDetail', array('order_id' => $v['id'], 'encrypt_id' => $encrypt_id)); ?>"
...
<div id="footer">
    <ul>
        <li class="li01"><a href="<?php echo Yii::app()->createUrl('mall/Commodity/Index', array('encrypt_id' => $encrypt_id)); ?>"></a></li>
        <li class="li02"><a href="<?php echo Yii::app()->createUrl('mall/Commodity/CommodityList', array('encrypt_id' => $encrypt_id)); ?>"></a></li>
        <li class="li04"><a href="<?php echo Yii::app()->createUrl('mall/Cart/CartList', array('encrypt_id' => $encrypt_id)); ?>"></a></li>
        <li class="li05"><a href="<?php echo Yii::app()->createUrl('mobile/uCenter/user/MemberCenter', array('encrypt_id' => $encrypt_id)); ?>"></a></li>
    </ul>
</div><!--footer end-->
</body>
