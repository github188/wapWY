    ...
    <section class="refundWrap">
        ...
        <article class="refundAdd clearfix">
            ...
            <article class="clearfix">
                <button class="btn_green"
                        onclick="applyRefund(<?php echo $order_sku_id ?>,<?php echo $order_id ?>,<?php echo $order_status ?>);">
                    填写退货物流信息
                </button>
            </article>
        </article>
        <article class="refundInfo">
            <div class="filed">
                ...
                <span class="text"><?php echo date('Y.m.d H:i:s', strtotime($data['apply_refund_time'])); ?></span>
            </div>
            <div class="filed">
...
<div class="pop refunded" id="popRefund" style="display:none">
    <div class="pop_con">
        <!--        选择地址--><?php //echo Yii::app()->createUrl('mall/order/applyRefundObj',array('order_sku_id'=>$list['order_sku'][$i]['id'],'order_id'=>$list['id'],'order_status'=>$list['order_status'])); ?>
        <?php echo CHtml::beginForm(Yii::app()->createUrl('mall/Order/RefundMsg'), 'post'); ?>
        <div class="title">
            <h5>退货信息</h5>
