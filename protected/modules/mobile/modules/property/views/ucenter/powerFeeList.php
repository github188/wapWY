<div class="prop_wrap prop_wanterRent">
    <div class="weui_tab weui_tab35">
        <div class="weui_navbar">
            ...
            <a class="weui_navbar_item weui_bar_item_on" onclick="window.location.href= '<?php echo Yii::app()->createUrl('mobile/property/Ucenter/powerFeeList',array('encrypt_id' => $this->getEncryptId()));?>'">
    ...
    <?php if(!empty($list)){?>
        <?php foreach($list as $k => $v){?>
            <div class="weui_panel weui_panel_access defined_panel" onclick="window.location.href= '<?php echo Yii::app()->createUrl('mobile/property/fee/powerFeeView', array('id' => $v['id'], 'encrypt_id' => $encrypt_id));?>' ">
                ...
                <div class="weui_panel_bd">
                    <div class="weui_media_box weui_media_text">
                        <h4 class="weui_media_title">
                            <div class="name">
                                <span class="icon_label_people mr10"></span>
                                    <?php echo $v['name'];?>
                        ...
                        <p class="weui_media_desc">
                            电费：<em>¥<?php echo $v['order_money'];?></em>
                        </p>
                    </div>
                </div>
            </div>
