...
<div class="prop_wrap prop_review_wrap">
    <div class="weui_panel">
        <div class="step_wrap">
            <div class="step_num">
                ...
                <div class="step_com step_3 highlight_green">3</div>
            </div>
            <ul class="step_text">
                <li class="highlight_green">提交信息</li>
                <li class="highlight_green">审核中</li>
                <li class="highlight_green">审核结果</li>
            </ul>
        </div>
    </div>
    ...
    <div class="weui_btn_area login_area">
        <a class="weui_btn weui_btn_primary" href="<?php echo $this->createUrl('Ucenter/index', array('encrypt_id' => $encrypt_id)); ?>" id="login_btn">点击登录</a>
    </div>
</div>
