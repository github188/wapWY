<title>完善注册信息</title>
<?php echo CHtml::beginForm(Yii::app()->createUrl('mobile/property/User/SignFail', array('encrypt_id' => $encrypt_id)), 'post'); ?>
    ...
    <div class="weui_cells weui_cells_form">
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('name', !empty($proprietor_Info['name']) ? $proprietor_Info['name'] : '', array('class' => 'weui_input', 'placeholder' => '请输入您的真实姓名')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">手机号 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::numberField('mobile_phone', !empty($proprietor_Info['account']) ? $proprietor_Info['account'] : '', array('class' => 'weui_input', 'placeholder' => '请输入您的手机号')); ?>
            </div>
        </div>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::passwordField('pwd', !empty($proprietor_Info['pwd']) ? $proprietor_Info['pwd'] : '', array('class' => 'weui_input', 'placeholder' => '请输入您的密码')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">门禁卡号 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('access_control_card_no', !empty($proprietor_Info['access_control_card_no']) ? $proprietor_Info['access_control_card_no'] : '', array('class' => 'weui_input', 'placeholder' => '请输入您的门禁卡号')); ?>
            </div>
        </div>
    </div>
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('building_number', !empty($proprietor_Info['building_number']) ? $proprietor_Info['building_number'] : '', array('class' => 'weui_input', 'placeholder' => '如：2号楼或2')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">房间 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('room_number', !empty($proprietor_Info['room_number']) ? $proprietor_Info['room_number'] : '', array('class' => 'weui_input', 'placeholder' => '如：502室或502')); ?>
            </div>
        </div>
    </div>
...
<div class="prop_wrap prop_family prop_family_add" style="display: none;">
    ...
    <div class="weui_cells weui_cells_form" >
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">姓名 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('member_name', !empty($proprietor_Info['family_members']) ? json_decode($proprietor_Info['family_members'])[0] : '', array('class' => 'weui_input', 'placeholder' => '请输入家庭成员真实姓名')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">手机号 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::numberField('member_phone', !empty($proprietor_Info['family_members']) ? json_decode($proprietor_Info['family_members'])[1] : '', array('class' => 'weui_input', 'placeholder' => '请输入家庭成员手机号')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">门禁卡号 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('member_access_control_card_no', !empty($proprietor_Info['family_members']) ? json_decode($proprietor_Info['family_members'])[2] : '', array('class' => 'weui_input', 'placeholder' => '请输入家庭成员门禁卡号')); ?>
            </div>
        </div>
        <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">与业主关系 <em class="cRed">*</em></label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <?php echo CHtml::textField('relationship', !empty($proprietor_Info['family_members']) ? json_decode($proprietor_Info['family_members'])[3] : '', array('class' => 'weui_input', 'placeholder' => '如：父亲')); ?>
            </div>
        </div>
    </div>
    <div class="weui_cell">
