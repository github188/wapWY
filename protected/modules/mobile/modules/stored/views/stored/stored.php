...
<body>
	<?php echo CHtml::beginForm(Yii::app()->createUrl('mobile/stored/stored/payway'),'get',array('name'=>'user_payway'));?>
	<div class="storedWrap">
        	...
        	<div class="rItem clearfix">
                <div class="l">
                    <div class="checkboxCom <?php if($key['key'] == $v['id']){?>checkboxComCur<?php }?>">
                        <input type="checkbox" id="checkbox01"  <?php if($key['key'] == $v['id']){?>checked="checked"<?php }?> value="<?php echo $v['id'];?>">
                ...
                <div class="r" <?php if($key['key'] != $v['id']){?>style="display:none"<?php }?>>
                    <div class="num_select">
                        ...
                        <input type="text" class="text" maxlength="4" value="1" />
        ...
        <div class="description"><a href="<?php echo Yii::app() -> createUrl('mobile/stored/stored/StoredOrderList', array('encrypt_id' => $encrypt_id));?>">储值明细</a></div>
        <br><br><br><br><br><br><br>
        <br><br><br><br><br><br><br>

        <div class="btnwrap">
            <input type="hidden" id="stored_id" name="stored_id" value="<?php if (!empty($key['key'])) { echo $key['key']; } ?>">
            <input type="hidden" id="stored_num" name="stored_num" value="1">
...
$('.minus-light').click(function(){
    ...
    $('#stored_num').val($(this).parent().find("input").val());
});
...
$('.l').bind("click",function(){
    ...
    $('#stored_id').val($(this).children().find('#checkbox01').val());
