...
<article id="card">
    <div class="list_item">
        <section class="info">
            <a href="<?php echo Yii::app()->createUrl('uCenter/user/personalInformation', array('encrypt_id' => $encrypt_id)) ?>">
                <div class="img">
                ...
                <div class="text">
                    ...
                    <span><?php echo $data['grade_name'] ?>积分:<?php echo isset($data['points']) ? $data['points'] : '0' ?></span>
                </div>
                <span class="jt"></span>
            </a>
        </section>
        <section class="menu">
            <ul>
                <li>
                    <a href="<?php echo Yii::app()->createUrl('uCenter/Stored/stored', array('encrypt_id' => $encrypt_id)) ?>">
                        <span class="icon1"></span><?php echo number_format($data['money'], 2); ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo Yii::app()->createUrl('uCenter/Coupon/CouponList', array('encrypt_id' => $encrypt_id)) ?>">
                        <span class="icon2"></span><?php echo $data['coupons_num'] ?>张
                    </a>
                </li>
                <li>
                    <a href="<?php echo Yii::app()->createUrl('uCenter/user/memberShipCard', array('encrypt_id' => $encrypt_id)) ?>">
        ...
        <?php if ($merchant_id != TIANSHI_SHOP_API) { ?>
            <section class="item item_2">
                <a class="intergral"
                   href="<?php echo Yii::app()->createUrl('uCenter/user/orderList', array('stored_confirm_status' => ORDER_PAY_WAITFORCONFIRM, 'encrypt_id' => $encrypt_id)) ?>">
            ...
            <section class="item item_3">
                <a class="intergral"
                   href="<?php echo Yii::app()->createUrl('uCenter/user/bookList', array('encrypt_id' => $encrypt_id,)) ?>">
                    <span class="ico"></span>我的预订<span class="jt"></span>
                </a>
            </section>
            <section class="item item_4">
                <a class="intergral"
                   href="<?php echo Yii::app()->createUrl('uCenter/user/shop', array('encrypt_id' => $encrypt_id,'source' => 'wechat')) ?>">
    ...
    $(function () {
        ...
        $('#upload').uploadify({
            ...
            onUploadSuccess: function (file, data, response) {//一个文件上传成功后的响应事件处理
                ...
                $.ajax({
                    url: '<?php echo(Yii::app()->createUrl('uCenter/User/setAvatar'));?>',
                    data: {id: id, img: fileName},
                    dataType: "json",
                    type: 'get',
