...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTitle" style="height: 30px; line-height: 30px; font-family: Microsoft Yahei; font-size: 10px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
